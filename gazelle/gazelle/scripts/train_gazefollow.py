...
parser.add_argument('--wandb_project', type=str, default='sam_dinov2_vitb_lora_mult_input')
parser.add_argument('--exp_name', type=str, default='train_sam_dinov2_vitb_lora_multi_input')
